 ...
 * @see natsMicroserviceEndpoint_AddEndpoint()
 */
typedef void (*natsMicroserviceRequestHandler)(natsMicroservice *m, natsMicroserviceRequest *req, void *closure);

/**
 * The Microservice schema object.
 */
...
typedef struct natsMicroserviceConfig
{
    ...
    const char *version;
    const char *description;
    natsMicroserviceEndpointConfig *endpoint;
